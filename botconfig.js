module.exports = {
  ...
  Lavalink: {
    ...
    port: parseInt(process.env.NODE_PORT,10), // The port that lavalink is listening to. This must be a number!
    pass: process.env.NODE_PASSWORD, //- The password of the lavalink server.
    secure: process.env.NODE_SECURE === 'true', // Set this to true if the lavalink uses SSL. if not set it to false.
